...
@onready var ram_check: CheckBox = $PanelContainer/VBoxContainer/RamTask
...
func _ready() -> void:
	...
	ram_check.button_pressed = false
	...
	ram_check.mouse_filter = Control.MOUSE_FILTER_IGNORE
...
func _on_ram_installed() -> void:
	ram_check.button_pressed = true
	print("Task: ram checked off!")
